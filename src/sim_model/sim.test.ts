...
test('Basic entity creation.', () => {
    ...
    const pline = sim.addPline([p0, p1], false);
...
test('Attributes.', () => {
    ...
    sim.addAttrib(ENT_TYPE.POINTS, 'bb', DATA_TYPE.NUM);
    ...
    expect(sim.getAttribVal(point, 'bb')).toBe(123);
    ...
    expect(sim.query(ENT_TYPE.POINTS, 'bb', COMPARATOR.IS_EQUAL, 123)).toEqual(['pt0']);
